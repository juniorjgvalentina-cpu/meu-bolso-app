...
// Lista pendencias nao resolvidas da conta (dono e membros com visao completa
// veem tudo; membros restritos so as proprias).
...
router.post('/pendencias/:id/resolver', autenticar, async (req, res) => {
  ...
  try {
    ...
    // Se for recorrente, ja cria a proxima pendencia do mes seguinte automaticamente.
