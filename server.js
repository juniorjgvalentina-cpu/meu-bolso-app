  ...
  try {
    ...
    for (let i = 0; i < 36; i++) {
      ...
      for (const p of candidatos.rows) {
        ...
        await pool.query(
          `INSERT INTO contas_pendentes (conta_id, membro_id, tipo, nome, valor, data_vencimento, recorrente, cartao_id)
           VALUES ($1, $2, $3, $4, $5, $6, TRUE, $7)`,
          [p.conta_id, p.membro_id, p.tipo, p.nome, p.valor, proximaData, p.cartao_id]
        );
        geradas++;
      }
    }
